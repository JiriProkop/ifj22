...
expr_tests :
	...
	./ic22int $(TESTDIR)tests_expr.output
...
$(TESTDIR)tests_stack: $(SOURCES)stack.o $(SOURCES)error.o $(SOURCES)dynstr.o
	$(CC) $(CFLAGS) $^ $@.c -o $@
$(TESTDIR)tests_expr: $(SOURCES)expr.o $(SOURCES)parser.o $(SOURCES)scanner.o $(SOURCES)error.o $(SOURCES)dynstr.o $(SOURCES)stack.o $(SOURCES)symtable.o $(SOURCES)ll.o $(SOURCES)expr_codegen.o
	$(CC) $(CFLAGS) $^ $@.c -o $@ $(LDLIBS)
